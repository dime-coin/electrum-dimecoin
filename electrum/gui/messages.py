...
MSG_FREEZE_ADDRESS = _("When you freeze an address, the funds in that address will not be used for sending dimecoins.")
MSG_FREEZE_COIN = _("When you freeze a coin, it will not be used for sending dimecoins.")
