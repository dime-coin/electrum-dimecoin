...
exe_standalone = EXE(
    ...
    icon=ICONS_FILE,
    console=False)
    # console=True makes an annoying black box pop up, but it does make Electrum-Dime output command line commands, with this turned off no output will be given but commands can still be used
