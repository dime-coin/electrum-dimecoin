...
if sys.version_info[:3] < _min_python_version_tuple:
    sys.exit("Error: Electrum-Dime requires Python version >= %s..." % MIN_PYTHON_VERSION)
...
setup(
    ...
    description="Lightweight Dimecoin Wallet",
    author="Dimecoin Developers",
    author_email="developer@dimecoinnetwork.com",
    license="MIT Licence",
    url="https://www.dimecoinnetwork.com",
    long_description="""Lightweight Dimecoin Wallet""",
)
